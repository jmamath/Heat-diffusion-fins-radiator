...
//===================================================================
//  dÈfinition des 6 types de base de tableaux a 1,2 et 3 paramËtres
//===================================================================
...
cout<<"================================================"<<endl;
cout<<"  dÈclaration et initialisation d'un vecteur    "<<endl;
cout<<"================================================"<<endl;

  Rn a(n,f);             // initialisation avec $a_i=f(i)$
  Rn b(n),c(n);          // initialisation par dÈfaut ‡ 0
...
cout<<"================================================"<<endl;
cout<<"  les opÈrations vectorielles optimisÈes        "<<endl;
cout<<"================================================"<<endl;
...
cout<<"================================================"<<endl;
cout<<"  dÈclaration et initialisation d'une matrice   "<<endl;
cout<<"================================================"<<endl;
...
cout<<"================================================"<<endl;
  ...
  assert( & A(0,3) == & Ai3(0)); //  vÈrification des adresses
...
cout<<"================================================"<<endl;
cout<<"  opÈrations avec matrices                      "<<endl;
cout<<"================================================"<<endl;

    b = 1;            //tous les ÈlÈments de b sont =1
...
cout<<"================================================"<<endl;
cout<<"  tableaux ‡ trois indices                      "<<endl;
cout<<"================================================"<<endl;

   Rnmk B(3,4,5);

   for (int i=0;i<B.N();i++)          // premiËre dimension
         for (int j=0;j<B.M();j++)    // deuxiËme dimension
             for (int k=0;k<B.K();k++)// troisiËme dimension
